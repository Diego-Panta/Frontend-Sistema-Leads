...
import { contactEmail } from '@/shared/site';
  ...
  pdfElement.innerHTML = `
    <div style="text-align: center; margin-bottom: 30px;">
      <div style="display: inline-flex; align-items: center; gap: 12px; margin-bottom: 20px; padding: 12px 24px; background: rgba(251, 191, 36, 0.2); border-radius: 50px; border: 1px solid rgba(251, 191, 36, 0.3);">
        <span style="font-size: 18px; color: #fbbf24;">CRMSM · Documento informativo</span>
      </div>
      <h1 style="font-size: 36px; font-weight: bold; margin: 0 0 10px 0; color: white;">Automecánica San Miguel</h1>
      <h2 style="font-size: 24px; font-weight: 300; margin: 0 0 20px 0; color: #fbbf24;">Sistema de citas y taller</h2>
      <p style="font-size: 16px; color: #fecaca; margin: 0;">CRMSM — seguimiento transparente de servicios</p>
      <p style="font-size: 14px; color: #fecaca; margin: 5px 0 0 0;">San Miguel, Perú</p>
    </div>
    ...
    <div style="background: rgba(255, 255, 255, 0.1); padding: 25px; border-radius: 20px; margin-bottom: 30px; border: 1px solid rgba(255, 255, 255, 0.2);">
      <h3 style="font-size: 20px; font-weight: bold; margin: 0 0 15px 0; color: #fbbf24; text-align: center;">Servicios destacados</h3>
    ...
    <div style="background: rgba(255, 255, 255, 0.1); padding: 25px; border-radius: 20px; margin-bottom: 30px; border: 1px solid rgba(255, 255, 255, 0.2);">
      <h3 style="font-size: 24px; font-weight: bold; margin: 0 0 25px 0; color: #fbbf24; text-align: center;">Cronograma sugerido</h3>
    ...
    <div style="background: rgba(251, 191, 36, 0.2); padding: 25px; border-radius: 20px; text-align: center; border: 1px solid rgba(251, 191, 36, 0.3);">
      <h3 style="font-size: 20px; font-weight: bold; margin: 0 0 15px 0; color: #fbbf24;">Recepción y asesoría</h3>
      <p style="font-size: 16px; color: white; margin: 0 0 20px 0;">Equipo CRMSM — Automecánica San Miguel</p>
      
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-top: 25px;">
        <div style="text-align: left;">
          <h4 style="font-size: 16px; font-weight: bold; margin: 0 0 10px 0; color: #fbbf24;">📞 Contacto</h4>
          <p style="font-size: 12px; color: #fecaca; margin: 2px 0;">${contactEmail}</p>
        ...
        <div style="text-align: left;">
          ...
          <p style="font-size: 12px; color: #fecaca; margin: 2px 0;">Taller mecánico certificado</p>
          <p style="font-size: 12px; color: #fecaca; margin: 2px 0;">San Miguel, Perú</p>
        </div>
      </div>
    </div>

    <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid rgba(255, 255, 255, 0.2);">
      <p style="font-size: 12px; color: #fecaca; margin: 5px 0;">¡Gracias por confiar en nosotros con tu vehículo!</p>
